  ...
  return (
    <section id="context-engineering" className="py-20 md:py-32 relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="label-mono text-accent-deep mb-4">Context &amp; Harness Engineering</p>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            the right context, not just better prompts. They also need
            <span className="text-foreground font-medium"> harness engineering</span> — the scaffolding around the model
            (a controller, agent routing, retrieval, and feedback loops) that turns that context into reliable execution.
          </p>
        </motion.div>
