...
export default function Pricing() {
  return (
    <section className="md:pt-24 pt-12 md:pb-8 pb-6 dark:bg-[#0F172A] relative overflow-hidden " id="pricing">
      ...
      <div className=" mx-auto px-4 relative z-10 text-center">
        <h2 className="text-4xl md:text-6xl font-bold dark:text-white mb-8 tracking-tight text-balance">
          Pricing built for <br /> product teams.
        </h2>
        <p className="text-xl dark:text-white/70 mb-10 max-w-2xl mx-auto text-pretty">
          Start free. Upgrade when your team is ready to replace the spreadsheets.
        </p>
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col p-10">
                  ...
                  <p className="mt-4 text-xs opacity-70">For curious builders, students, and early-stage founders.</p>

                  <ul className="mt-6 space-y-3 text-xs">
                    <li className="flex gap-2">
                      <span className="mt-1">✅</span>
                      <span className="leading-relaxed">1 active project</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="mt-1">✅</span>
                    ...
                    <li className="flex gap-2">
                      <span className="mt-1">✅</span>
                      <span className="leading-relaxed">Basic AI task refinement</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="mt-1">✅</span>
                      <span className="leading-relaxed">Limited AI usage (daily cap)</span>
                    </li>
                  </ul>
                 < a href="/auth"> <button
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col p-10">
                  <span className="w-fit rounded-xl bg-white/10 px-2 py-1 text-xs font-bold uppercase">Builder</span>

                  <h2 className="mt-2 text-3xl font-medium">$29 / month</h2>

                  <p className="mt-4 text-xs opacity-70">For solo founders, freelancers, and consultants. </p>

                  <ul className="mt-6 space-y-3 text-xs" data-tier="builder">
                    <li className="flex gap-2">
                      <span className="mt-1">✅</span>
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col p-10">
                  ...
                  <h2 className="mt-2 text-3xl font-medium">$99 / month</h2>

                  <p className="mt-4 text-xs opacity-70">For agencies, startups, and small teams.</p>
                  ...
                  <ul className="mt-6 space-y-3 text-xs">
                    ...
                    <li className="flex gap-2">
                      <span className="mt-1">✅</span>
                      <span className="leading-relaxed">Advanced AI reasoning</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="mt-1">✅</span>
                      <span className="leading-relaxed">Team collaboration (up to 10 users)</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="mt-1">✅</span>
                      <span className="leading-relaxed">
                        Integrations (Jira,Notion,Asana, <br />
                        Monday phased rollout)
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <span className="mt-1">✅</span>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col p-10">
                  <span className="w-fit rounded-xl bg-white/10 px-2 py-1 text-xs font-bold uppercase">Customise</span>

                  <h2 className="mt-auto text-3xl font-medium">Custom pricing</h2>

                  <p className="mt-4 text-xs opacity-70">For universities, enterprises, and regulated industries.</p>
                  ...
                  <a href="https://calendly.com/requisor" target="_blank" rel="noopener noreferrer"><button
                    className="mt-5 rounded-xl border border-white/30
                           bg-white/5 px-4 py-2 font-semibold
                           backdrop-blur hover:bg-white/10 transition"
                  >
        ...
        <p className="md:mt-20 mt-10 text-sm dark:text-white/40">No credit card required · Cancel anytime</p>
