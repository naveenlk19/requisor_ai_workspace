...
const sourceLogo = (domain: string) => `https://img.logo.dev/${domain}?token=${LOGO_TOKEN}&size=80&format=png`;
      ...
      <div className="grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-[5.25rem] leading-[0.98] font-medium text-balance mb-8">
            Ship features that <span className="text-muted-foreground">win deals</span>,
            with AI that <span className="text-accent-deep">listens to every customer</span>.
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-xl text-pretty mb-10 leading-relaxed">
            Unify customer signal across every tool. Run AI agents on top. Ship the right
            thing, with the receipts.
          </p>
          ...
          <p className="mt-4 label-mono">No credit card. Free for 1 project.</p>
