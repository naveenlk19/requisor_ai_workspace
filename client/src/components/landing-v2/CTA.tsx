        ...
        <div className="relative max-w-2xl">
          ...
          <div className="flex flex-wrap gap-3">
            <a  href="/auth" className="inline-flex items-center gap-2 bg-foreground text-background px-6 py-3.5 rounded-full text-sm font-medium hover:bg-foreground/90 transition-all">
              Start free <span className="font-mono">→</span>
            </a>
            <a href="https://calendly.com/requisor" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full text-sm font-medium text-accent-foreground border border-accent-foreground/25 hover:bg-accent-foreground/10 transition-colors">
              Talk to founder <span className="font-mono">→</span>
            </a>
          </div>
          <div className="mt-6">
            <a href="/architecture" className="inline-flex items-center gap-2 text-sm text-accent-foreground/70 hover:text-accent-foreground transition-colors">
              Read the architecture post <span className="font-mono text-xs">→</span>
            </a>
          </div>
        </div>
      </div>
