const Shift = () => (
  <section id="shift" className="py-28 md:py-36 bg-foreground text-background relative overflow-hidden">
    ...
    <div className="container max-w-7xl mx-auto relative">
      ...
      <p className="mt-16 max-w-2xl text-background/60 leading-relaxed">
        The same shift that happened from on-prem to cloud, from waterfall to agile, from manual QA to test automation.
        Each time, the incumbents had the wrong architecture and could not retrofit.
      </p>
    </div>
  </section>
);
